...
public class Appraisal {
	...
	public String toString() {
		return "Appraisal [position=" + position + ", department=" + department + ", supervisor=" + supervisor
				+ ", reviewfrom=" + reviewfrom + ", reviewend=" + reviewend + ", performancereview=" + performancereview
				+ "]";
	}
	}
